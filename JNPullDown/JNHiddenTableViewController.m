//
//  JNHiddenTableViewController.m
//  JNPullDown
//
//  Created by jamesn on 4/28/14.
//  Copyright (c) 2014 jamesn. All rights reserved.
//

#import "JNHiddenTableViewController.h"

@interface JNHiddenTableViewController () <UITableViewDataSource, UITableViewDelegate>
@property (nonatomic, strong) NSArray *arrayItems;
@end

@implementation JNHiddenTableViewController
...
{
    [super viewDidLoad];
    _arrayItems = @[@"hidden item 1", @"hidden item 2", @"hidden item 3"];
